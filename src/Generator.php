...
use Exception;
use Kai\L5Swagger\Exceptions\InvalidDefinitionException;
use ReflectionClass;
...
use Kai\L5Swagger\Parameters;
use Kai\L5Swagger\DataObjects;
...
use Kai\L5Swagger\Definitions\DefinitionGenerator;
use Kai\L5Swagger\Exceptions\InvalidAuthenticationFlow;
use Kai\L5Swagger\Exceptions\SchemaBuilderNotFound;
...
class Generator {
    ...
    private function generateCustomResponseSchema(string $operation, string $model, string $uri) {
        ...
        try {
            ...
            throw new Exception("SchemaBuilder must implements Kai\L5Swagger\Responses\SchemaBuilder interface");
        }
    }
